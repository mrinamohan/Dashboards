# Excel Dashboard
This project aims to create an interactive Excel dashboard that contains data based on revenue and profit. Utilizing Slicers, users can easily filter and analyze the data, gaining insights into sales performance, financial metrics, and mode of sales, empowering effective decision-making and improving overall business performance.
